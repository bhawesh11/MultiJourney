...
//	---------------------------------------------------------------------------------------
	...
	public void TC007() throws InterruptedException, IOException{
		...
		PolicyStatrDate.policyStartDate();
		Quote.quote();
		RightPanel.AddDriver();
		DriverInfo1of2.driverInfo1of2();
		DriverInfo2of2.driverInfo2of2();
		DriverList.driverList_RemoveDriver();
		InsuranceHistory.insuranceHistory_No();
		PolicyStatrDate.policyStartDate();
		Quote.quote();
		ConfirmDriver.confirmDriver_Extra();
...
//	---------------------------------------------------------------------------------------
	...
	public void TC008() {
		...
		VehicleList.vehicleList();
		PolicyHolderDetails1of2.policyHolderDetails1of2();
		PolicyHolderDetails2of2.policyHolderDetails2of2_LicenseStatus();
		GetInfo.GetLicenseStatus();
